...
class BaseConfig(object):
    ...
    OIDC_RESOURCE_SERVER_ONLY = os.environ.get("FLASK_OIDC_RESOURCE_SERVER_ONLY", False)
    OIDC_RESOURCE_SERVER_VALIDATION_MODE = os.environ.get("FLASK_OIDC_RESOURCE_SERVER_VALIDATION_MODE", 'online')
